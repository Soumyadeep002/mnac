...
const whitelogo = document.querySelector("#whitelogo")
        ...
        menu_btn.addEventListener("click", function () {
            ...
            if(window.scrollY < 100){
                ...
                menulist.classList.toggle("md:text-white");
                menulist.classList.toggle("md:text-black");
                blacklogo.classList.toggle("block")
                blacklogo.classList.toggle("hidden")
                whitelogo.classList.toggle("hidden")
                whitelogo.classList.toggle("block")
                    for (let i = 0; i < menuline.length; i++) {
                        menuline[i].classList.toggle("bg-white")
                        menuline[i].classList.toggle("bg-black")
                    }
            }
